...
- **Process**:
  ...
  3. Extracts survey ID from Training Request's Participant_Survey\_\_c field
...
- **Process**:
  ...
  2. Handler checks each survey field (Participant_Survey**c, Customer_Survey**c, Trainer_Survey\_\_c)
...
1. Ensure SurveyInvitation**c object exists with required fields (Token**c, Survey**c, Status**c, etc.)
2. Ensure SiteURL\_\_c custom setting is configured with 'EAP Training' and 'Reseller Training' entries
3. Ensure SurveySettings\_\_c custom setting exists
