...
### Data Model
- **Training_Request__c**: Source of Training Request IDs
  - Participant_Survey__c (URL field)
  - Customer_Survey__c (URL field)
  - Trainer_Survey__c (URL field)
- **Survey__c**: Surveys to regenerate
- **SurveyInvitation__c**: Invitations to delete and create
- **Participants__c**: For participant survey regeneration
