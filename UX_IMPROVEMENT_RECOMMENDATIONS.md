...
<lightning-combobox
    ...
    value={currentQuestion.scaleStartLabel}
    options={scaleStartLabelOptions}
    onchange={handleScaleStartLabelChange}>
</lightning-combobox>
<lightning-helptext
    ...
    <div class="slds-card slds-m-bottom_medium">
        <div class="slds-card__body slds-card__body_inner slds-p-around_medium">
            <div class="slds-text-align_center">
                <lightning-spinner
                    alternative-text="Generating survey invitations..."
                    size="medium">
                </lightning-spinner>
                <p class="slds-m-top_medium">
                    Generating {totalToGenerate} survey invitations...
                </p>
                ...
                <p class="slds-text-color_weak slds-m-top_small">
                    {generatedCount} of {totalToGenerate} created
                </p>
            </div>
        </div>
    </div>
...
<template lwc:if={isSubmitting}>
    <div class="submission-overlay">
        <div class="submission-content">
            <lightning-spinner
                alternative-text="Submitting your responses..."
                size="large">
            </lightning-spinner>
...
<template lwc:if={hasNoSurveys}>
    <div class="slds-illustration slds-illustration_large">
        ...
        <p class="slds-text-body_regular slds-text-color_weak slds-m-bottom_medium">
            Create your first survey to start collecting valuable feedback from your audience.
            Surveys help you understand customer satisfaction, employee engagement, and more.
        </p>
        <lightning-button
            variant="brand"
            label="Create Your First Survey"
            icon-name="utility:add"
            onclick={handleCreateFirstSurvey}>
        </lightning-button>
        <div class="slds-m-top_medium">
            <a href="#" onclick={handleViewGettingStarted}>
...
<template lwc:if={hasNoQuestions}>
    <div class="slds-illustration slds-illustration_small slds-p-around_large">
        <lightning-icon
            icon-name="utility:questions_and_answers"
            size="large"
        ...
        <p class="slds-text-body_small slds-text-color_weak slds-m-bottom_medium">
            ...
            free text, single select, multi-select, and rating scales.
        </p>
        <lightning-button
            variant="brand"
...
<section class="card" role="main" aria-labelledby="survey-title">
    ...
    <template lwc:if={showAnonymousSelection}>
        <div role="radiogroup" aria-labelledby="anonymous-heading">
            ...
            <div class="questionHelp" id="anonymous-help">
                Select whether to include your name with this response.
            </div>
    ...
    <template lwc:else>
        <template lwc:if={currentQuestion}>
            ...
            <div class="questionHelp" id="question-help">
                {questionHelpText}
            </div>
            
            <!-- Add skip link for keyboard users -->
            <a href="#" class="slds-assistive-text slds-assistive-text_focus" onclick={handleNext}>
        ...
        <div class="slds-modal__container">
            ...
            <div class="slds-modal__content slds-p-around_medium">
                <p class="slds-m-bottom_medium">
                    Are you sure you want to delete this {deleteConfirmationType}? This action cannot be undone.
                </p>
                ...
                <template lwc:if={hasRelatedRecords}>
                    <div class="slds-m-top_medium">
                        ...
                        <span class="slds-text-color_weak">
                            This will also delete {relatedRecordCount} related {relatedRecordType}.
                        </span>
                    </div>
                </template>
            </div>
        ...
        <div class="preview-banner-content">
            ...
            <div class="preview-banner-actions">
                <lightning-button-group>
                    <lightning-button 
                        label="Test as Guest User" 
                        onclick={handlePreviewAsGuest}
                        variant="neutral">
                    </lightning-button>
                    <lightning-button 
                        label="Test Anonymous" 
                        onclick={handlePreviewAsAnonymous}
                        variant="neutral">
                    </lightning-button>
                    <lightning-button 
                        label="Edit Survey" 
